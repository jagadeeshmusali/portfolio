...
export const profileMock: Profile = {
  ...
  aboutMe:
    'Since beginning of my journey as a developer, I learned, mentored and worked happily with most talented people to create best products for business. Always believes in curiosity and continuous hard-work. Proud to say that I learn something useful daily.',
  ...
  technologies: {
    ...
    backend: {
      tagLine:
        "I have experience building RESTful APIs, and I'm always looking to improve my skills.",
      technologies: [
        'C#',
        'Nodejs',
        'Graph QL',
    ...
    mentor: {
      tagLine:
        'I believe in hard-work to get better each day, and love using that in helping fellow developers on their craft.',
      technologies: [
        'Coding',
        'Best practices',
        'Hackwars',
